...
const exportExcel = async (req, res) => {
  try {
    ...
    const buffer = await thongKeService.exportExcel(tuNgay, denNgay, nguoiXuat, maTuyenDuong, maXaPhuong, loaiNgay, maLoaiCongViec, trangThai);
...
const exportPDF = async (req, res) => {
  try {
    ...
    const buffer = await thongKeService.exportPDF(tuNgay, denNgay, nguoiXuat, maTuyenDuong, maXaPhuong, loaiNgay, maLoaiCongViec, trangThai);
