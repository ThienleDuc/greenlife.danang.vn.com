...
CREATE TABLE XaPhuong (
    ...
    CONSTRAINT CHK_XaPhuong_LoaiDanhMuc CHECK (
        LoaiDanhMuc IN (N'Xã', N'Phường')
    )
);
...
CREATE TABLE TuyenDuong (
    ...
    CONSTRAINT CHK_TuyenDuong_LoaiDuong CHECK (
        LoaiDuong IN (
            N'Đường lớn',
            N'đường nhánh',
            N'ngõ',
...
CREATE TABLE ChiTietPhanCong (
    ...
    CONSTRAINT CHK_ThoiGianLamViec CHECK (
